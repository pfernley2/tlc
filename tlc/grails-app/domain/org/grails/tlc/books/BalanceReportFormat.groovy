...
class BalanceReportFormat {
    ...
    static constraints = {
        ...
        column1Heading(nullable: true, size: 1..10, validator: {val, obj ->
            if (val && !obj.column1PrimaryData) return 'balanceReportFormat.columnHeading.no.heading'
            return true
        })
        column1SubHeading(nullable: true, size: 1..10, validator: {val, obj ->
            if (val && !obj.column1PrimaryData) return 'balanceReportFormat.columnSubHeading.no.heading'
            return true
        })
        column1PrimaryData(nullable: true, inList: DATA_OPTIONS, validator: {val, obj ->
            if (val) {
                if (!obj.column1Heading) return 'balanceReportFormat.columnPrimaryData.no.heading'
            } else {
        ...
        column1Calculation(nullable: true, inList: CALC_OPTIONS, validator: {val, obj ->
            if (val && !obj.column1PrimaryData) return 'balanceReportFormat.columnCalculation.no.primary'
            return true
        })
        column1SecondaryData(nullable: true, inList: DATA_OPTIONS, validator: {val, obj ->
            if (val) {
                if (obj.column1Calculation != 'difference' && obj.column1Calculation != 'variance') return 'balanceReportFormat.columnSecondaryData.no.secondary'
                if (val == obj.column1PrimaryData) return 'balanceReportFormat.columnSecondaryData.same.secondary'
            } else {
                if (obj.column1Calculation == 'difference' || obj.column1Calculation == 'variance') return 'balanceReportFormat.columnSecondaryData.need.secondary'
            }

            return true
        })
        column2Heading(nullable: true, size: 1..10, validator: {val, obj ->
            if (val && !obj.column2PrimaryData) return 'balanceReportFormat.columnHeading.no.heading'
            return true
        })
        column2SubHeading(nullable: true, size: 1..10, validator: {val, obj ->
            if (val && !obj.column2PrimaryData) return 'balanceReportFormat.columnSubHeading.no.heading'
            return true
        })
        ...
        column2Calculation(nullable: true, inList: CALC_OPTIONS, validator: {val, obj ->
            if (val && !obj.column2PrimaryData) return 'balanceReportFormat.columnCalculation.no.primary'
            return true
        })
        column2SecondaryData(nullable: true, inList: DATA_OPTIONS, validator: {val, obj ->
            if (val) {
                if (obj.column2Calculation != 'difference' && obj.column2Calculation != 'variance') return 'balanceReportFormat.columnSecondaryData.no.secondary'
                if (val == obj.column2PrimaryData) return 'balanceReportFormat.columnSecondaryData.same.secondary'
            } else {
                if (obj.column2Calculation == 'difference' || obj.column2Calculation == 'variance') return 'balanceReportFormat.columnSecondaryData.need.secondary'
            }

            return true
        })
        column3Heading(nullable: true, size: 1..10, validator: {val, obj ->
            if (val && !obj.column3PrimaryData) return 'balanceReportFormat.columnHeading.no.heading'
            return true
        })
        column3SubHeading(nullable: true, size: 1..10, validator: {val, obj ->
            if (val && !obj.column3PrimaryData) return 'balanceReportFormat.columnSubHeading.no.heading'
            return true
        })
        ...
        column3Calculation(nullable: true, inList: CALC_OPTIONS, validator: {val, obj ->
            if (val && !obj.column3PrimaryData) return 'balanceReportFormat.columnCalculation.no.primary'
            return true
        })
        column3SecondaryData(nullable: true, inList: DATA_OPTIONS, validator: {val, obj ->
            if (val) {
                if (obj.column3Calculation != 'difference' && obj.column3Calculation != 'variance') return 'balanceReportFormat.columnSecondaryData.no.secondary'
                if (val == obj.column3PrimaryData) return 'balanceReportFormat.columnSecondaryData.same.secondary'
            } else {
                if (obj.column3Calculation == 'difference' || obj.column3Calculation == 'variance') return 'balanceReportFormat.columnSecondaryData.need.secondary'
            }

            return true
        })
        column4Heading(nullable: true, size: 1..10, validator: {val, obj ->
            if (val && !obj.column4PrimaryData) return 'balanceReportFormat.columnHeading.no.heading'
            return true
        })
        column4SubHeading(nullable: true, size: 1..10, validator: {val, obj ->
            if (val && !obj.column4PrimaryData) return 'balanceReportFormat.columnSubHeading.no.heading'
            return true
        })
        ...
        column4Calculation(nullable: true, inList: CALC_OPTIONS, validator: {val, obj ->
            if (val && !obj.column4PrimaryData) return 'balanceReportFormat.columnCalculation.no.primary'
            return true
        })
        column4SecondaryData(nullable: true, inList: DATA_OPTIONS, validator: {val, obj ->
            if (val) {
                if (obj.column4Calculation != 'difference' && obj.column4Calculation != 'variance') return 'balanceReportFormat.columnSecondaryData.no.secondary'
                if (val == obj.column4PrimaryData) return 'balanceReportFormat.columnSecondaryData.same.secondary'
            } else {
                if (obj.column4Calculation == 'difference' || obj.column4Calculation == 'variance') return 'balanceReportFormat.columnSecondaryData.need.secondary'
            }
