...
<html>
<head>
    <title><g:msg code="show" domain="supplierAddress"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="show" domain="supplierAddress"/>
        ...
        <table>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierAddressInstance, field: 'id')}</td>
            ...
            <g:each in="${supplierAddressLines}" status="i" var="supplierAddressLine">
                <tr class="prop">
                    <td class="name">${supplierAddressLine.label?.encodeAsHTML()}</td>

                    <td class="value">${supplierAddressLine.value?.encodeAsHTML()}</td>
                </tr>
            </g:each>
                <tr class="prop">
                    <td class="vtop name"><g:msg code="supplierAddress.addressUsages.label" default="Usages"/></td>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierAddressInstance, field: 'securityCode')}</td>
                ...
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierAddressInstance, field: 'dateCreated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierAddressInstance, field: 'lastUpdated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierAddressInstance, field: 'version')}</td>
