...
<head>
    ...
    <title><g:msg code="create" domain="balanceReportFormat"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="balanceReportFormat"/>
    ...
    <g:form method="post" >
        ...
        <div class="buttons">
            ...
            <span class="button"><g:actionSubmit tabindex="5500" class="save" onclick="return linesNext()" action="Save" value="${msg(code:'balanceReportFormat.lines.label', 'default':'Lines')}"/></span>
        </div>
    </g:form>
</div>
</body>
