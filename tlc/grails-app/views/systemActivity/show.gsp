...
<head>
    ...
    <title><g:msg code="show" domain="systemActivity"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="show" domain="systemActivity"/>
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean: systemActivityInstance, field: 'id')}</td>

            </tr>

            <tr class="prop">
                <td class="name"><g:msg code="systemActivity.code.label" default="Code"/></td>

                <td class="value">${display(bean: systemActivityInstance, field: 'code')}</td>

            </tr>

            <tr class="prop">
                <td class="name"><g:msg code="systemActivity.systemOnly.label" default="System Only"/></td>

                <td class="value">${display(bean: systemActivityInstance, field: 'systemOnly')}</td>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean: systemActivityInstance, field: 'securityCode')}</td>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean: systemActivityInstance, field: 'dateCreated')}</td>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean: systemActivityInstance, field: 'lastUpdated')}</td>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean: systemActivityInstance, field: 'version')}</td>
