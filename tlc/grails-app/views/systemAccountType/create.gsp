...
<head>
    ...
    <title><g:msg code="create" domain="systemAccountType"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemAccountType"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[systemAccountTypeInstance: systemAccountTypeInstance]"/>
        <div class="buttons">
