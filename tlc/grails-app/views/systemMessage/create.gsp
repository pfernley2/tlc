...
<head>
    ...
    <title><g:msg code="create" domain="systemMessage"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemMessage"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[systemMessageInstance: systemMessageInstance]"/>
        <div class="buttons">
