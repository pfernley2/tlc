...
<head>
    ...
    <title><g:msg code="list" domain="systemMessage"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="list" domain="systemMessage"/>
    ...
    <div class="list">
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="code" title="Code" titleKey="systemMessage.code.label"/>

                <g:sortableColumn property="locale" title="Locale" titleKey="systemMessage.locale.label"/>

                <g:sortableColumn property="text" title="Text" titleKey="systemMessage.text.label"/>
