...
<head>
    ...
    <title><g:msg code="create" domain="taskResult"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="taskResult"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[taskResultInstance: taskResultInstance]"/>
        <div class="buttons">
