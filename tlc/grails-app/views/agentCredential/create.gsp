...
<head>
    ...
    <title><g:msg code="create" domain="agentCredential"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="agentCredential"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[agentCredentialInstance: agentCredentialInstance]"/>
        <div class="buttons">
