...
<head>
    ...
    <title><g:msg code="create" domain="companyUser"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="companyUser"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[companyUserInstance: companyUserInstance]"/>
        <div class="buttons">
