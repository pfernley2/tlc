...
<head>
    ...
    <title><g:msg code="create" domain="taxAuthority"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="taxAuthority"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[taxAuthorityInstance: taxAuthorityInstance]"/>
        <div class="buttons">
