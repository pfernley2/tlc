...
<head>
    ...
    <title><g:msg code="create" domain="systemRole"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemRole"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[systemRoleInstance: systemRoleInstance]"/>
        <div class="buttons">
