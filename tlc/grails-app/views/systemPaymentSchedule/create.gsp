...
<head>
    ...
    <title><g:msg code="create" domain="systemPaymentSchedule"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemPaymentSchedule"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[systemPaymentScheduleInstance: systemPaymentScheduleInstance]"/>
        <div class="buttons">
