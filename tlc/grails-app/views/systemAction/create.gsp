...
<head>
    ...
    <title><g:msg code="create" domain="systemAction"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemAction"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[systemActionInstance: systemActionInstance]"/>
        <div class="buttons">
