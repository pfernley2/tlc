...
<head>
    ...
    <title><g:msg code="list" domain="taxCode"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="list" domain="taxCode"/>
    ...
    <div class="list">
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="code" title="Code" titleKey="taxCode.code.label"/>

                <th><g:msg code="taxCode.name.label" default="Name"/></th>

                <th><g:msg code="taxCode.authority.label" default="Tax Authority"/></th>

                <th><g:msg code="taxCode.rates.label" default="Rates"/></th>
