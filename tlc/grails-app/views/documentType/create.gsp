...
<head>
    ...
    <title><g:msg code="create" domain="documentType"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="documentType"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[documentTypeInstance: documentTypeInstance]"/>
        <div class="buttons">
