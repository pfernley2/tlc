...
<head>
    ...
    <title><g:msg code="create" domain="paymentSchedule"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="paymentSchedule"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[paymentScheduleInstance: paymentScheduleInstance]"/>
        <div class="buttons">
