...
<head>
    ...
    <title><g:msg code="edit" domain="systemCustomerContactType"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="edit" domain="systemCustomerContactType"/>
    ...
    <g:form method="post" >
        ...
        <g:render template="form" model="[systemCustomerContactTypeInstance: systemCustomerContactTypeInstance]"/>
        <div class="buttons">
