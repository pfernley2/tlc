...
<head>
    ...
    <title><g:msg code="create" domain="codeElement"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="codeElement"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[codeElementInstance: codeElementInstance]"/>
        <div class="buttons">
