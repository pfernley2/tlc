...
<head>
    ...
    <title><g:msg code="create" domain="exchangeRate"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="exchangeRate"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[exchangeRateInstance: exchangeRateInstance]"/>
        <div class="buttons">
