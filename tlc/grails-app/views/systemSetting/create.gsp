...
<head>
    ...
    <title><g:msg code="create" domain="systemSetting"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemSetting"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[systemSettingInstance: systemSettingInstance]"/>
        <div class="buttons">
