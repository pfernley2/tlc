...
<head>
    ...
    <title><g:msg code="create" domain="systemCountry"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemCountry"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[systemCountryInstance: systemCountryInstance]"/>
        <div class="buttons">
