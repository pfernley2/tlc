...
<html>
<head>
    <title><g:msg code="show" domain="supplierContact"/></title>
</head>
<body>
<div class="nav" role="navigation">
    <span class="menuButton"><a class="home" href="${createLink(uri: '/')}"><g:msg code="default.home.label" default="Home"/></a></span>
    <span class="menuButton"><g:link class="menu" controller="systemMenu" action="display"><g:msg code="systemMenu.display" default="Menu"/></g:link></span>
    <span class="menuButton"><g:link class="list" action="list"><g:msg code="list" domain="supplierContact"/></g:link></span>
    <span class="menuButton"><g:link class="create" action="create"><g:msg code="new" domain="supplierContact"/></g:link></span>
</div>
<div id="main-content" class="body" role="main">
    <g:pageTitle code="show" domain="supplierContact"/>
        ...
        <table>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierContactInstance, field: 'id')}</td>
            ...
            <tr class="prop">
                <td class="name"><g:msg code="supplierContact.name.label" default="Name"/></td>

                <td class="value">${display(bean: supplierContactInstance, field: 'name')}</td>
            ...
            <tr class="prop">
                <td class="name"><g:msg code="supplierContact.identifier.label" default="Identifier"/></td>

                <td class="value">${display(bean: supplierContactInstance, field: 'identifier')}</td>
            ...
            <tr class="prop">
                <td class="vtop name"><g:msg code="supplierContact.usages.label" default="Usages"/></td>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierContactInstance, field: 'securityCode')}</td>
                ...
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierContactInstance, field: 'dateCreated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierContactInstance, field: 'lastUpdated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: supplierContactInstance, field: 'version')}</td>
