...
<head>
    ...
    <title><g:msg code="show" domain="scale"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="show" domain="scale"/>
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean:scaleInstance, field:'id')}</td>
            ...
            <tr class="prop">
                <td class="name"><g:msg code="scale.code.label" default="Code"/></td>

                <td class="value">${display(bean:scaleInstance, field:'code')}</td>
            ...
            <tr class="prop">
                <td class="name"><g:msg code="scale.name.label" default="Name"/></td>

                <td class="value"><g:msg code="scale.name.${scaleInstance.code}" default="${scaleInstance.name}"/></td>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean:scaleInstance, field:'securityCode')}</td>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean:scaleInstance, field:'dateCreated')}</td>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean:scaleInstance, field:'lastUpdated')}</td>
            ...
            <tr class="prop">
                ...
                <td class="value">${display(bean:scaleInstance, field:'version')}</td>
