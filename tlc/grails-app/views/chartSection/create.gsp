...
<head>
    ...
    <title><g:msg code="create" domain="chartSection"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="chartSection"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[chartSectionInstance: chartSectionInstance]"/>
        <div class="buttons">
