...
<head>
    ...
    <title><g:msg code="create" domain="systemUser"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemUser"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[systemUserInstance: systemUserInstance]"/>
        <div class="buttons">
