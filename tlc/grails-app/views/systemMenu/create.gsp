...
<head>
    ...
    <title><g:msg code="create" domain="systemMenu"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemMenu"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[systemMenuInstance: systemMenuInstance]"/>
        <div class="buttons">
