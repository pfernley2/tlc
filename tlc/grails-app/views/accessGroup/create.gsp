...
<head>
    ...
    <title><g:msg code="create" domain="accessGroup"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="accessGroup"/>
    ...
    <g:form action="save" method="post" >
        <g:render template="form" model="[accessGroupInstance: accessGroupInstance]"/>
        <div class="buttons">
