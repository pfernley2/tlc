...
<head>
    ...
    <title><g:msg code="create" domain="systemUnit"/></title>
</head>
<body>
...
<div id="main-content" class="body" role="main">
    <g:pageTitle code="create" domain="systemUnit"/>
    ...
    <g:form action="save" method="post">
        <g:render template="form" model="[systemUnitInstance: systemUnitInstance]"/>
        <div class="buttons">
