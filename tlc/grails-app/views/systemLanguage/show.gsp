...
<head>
    ...
    <title><g:msg code="show" domain="systemLanguage"/></title>
</head>
<body>
<div class="nav" role="navigation">
    <span class="menuButton"><a class="home" href="${createLink(uri: '/')}"><g:msg code="default.home.label" default="Home"/></a></span>
    <span class="menuButton"><g:link class="menu" controller="systemMenu" action="display"><g:msg code="systemMenu.display" default="Menu"/></g:link></span>
    <span class="menuButton"><g:link class="list" action="list"><g:msg code="list" domain="systemLanguage"/></g:link></span>
    <span class="menuButton"><g:link class="create" action="create"><g:msg code="new" domain="systemLanguage"/></g:link></span>
</div>
<div id="main-content" class="body" role="main">
    <g:pageTitle code="show" domain="systemLanguage"/>
        ...
        <table>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: systemLanguageInstance, field: 'id')}</td>

                </tr>
            </g:permit>

            <tr class="prop">
                <td class="name"><g:msg code="systemLanguage.code.label" default="Code"/></td>

                <td class="value">${display(bean: systemLanguageInstance, field: 'code')}</td>

            </tr>

            <tr class="prop">
                <td class="name"><g:msg code="systemLanguage.name.label" default="Name"/></td>

                <td class="value"><g:msg code="language.name.${systemLanguageInstance.code}" default="${systemLanguageInstance.name}"/></td>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: systemLanguageInstance, field: 'securityCode')}</td>
                ...
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: systemLanguageInstance, field: 'dateCreated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: systemLanguageInstance, field: 'lastUpdated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td class="value">${display(bean: systemLanguageInstance, field: 'version')}</td>
